/* 
	ADDED: to fix issues with running from fiugd.dev
	and following location.href changed to locationProxy.href
*/
const locationProxy = {
	get href(){
...
! function(e) {
    ...
    function u(e, t, n) {
        var o = a[e];
        o || (o = a[e] = new r.BrowserRenderer(e)), o.attachRootComponentToLogicalElement(n, t)
    }
    t.attachRootComponentToLogicalElement = u, t.attachRootComponentToElement = function(e, t, n) {
    ...
    function l(e, t, n) {
        ...
        var r = p(e);
        if (!t && h(r)) f(r, !1, n);
        else if (t && locationProxy.href === e) {
            var o = e + "?";
            history.replaceState(null, "", o), location.replace(e)
        } else n ? history.replaceState(null, "", r) : locationProxy.href = e
    }

    function f(e, t, n) {
        void 0 === n && (n = !1), i.resetScrollAfterNextBatch(), n ? history.replaceState(null, "", e) : history.pushState(null, "", e), d(t)
    }
    ...
    function d(e) {
        return r(this, void 0, void 0, (function() {
            return o(this, (function(t) {
                switch (t.label) {
                    case 0:
                        return c ? [4, c(locationProxy.href, e)] : [3, 2];
                    case 1:
                        t.sent(), t.label = 2;
                    case 2:
                        return [2]
    ...
    function p(e) {
        return (a = a || document.createElement("a")).href = e, a.href
    }
    ...
    t.internalFunctions = {
        listenForNavigationEvents: function(e) {
            if (c = e, s) return;
            s = !0, window.addEventListener("popstate", (function() {
                return d(!1)
            }))
        },
        ...
        navigateTo: l,
        getBaseURI: function() {
            return BINDING.js_string_to_mono_string(document.baseURI)
        },
        getLocationHref: function() {
            return BINDING.js_string_to_mono_string(locationProxy.href)
        }
    ...
    function u(e, t, n) {
        var a = e;
        if (e instanceof Comment && (c(a) && c(a).length > 0)) throw new Error("Not implemented: inserting non-empty logical container");
        if (s(a)) throw new Error("Not implemented: moving existing logical children");
        var i = c(t);
        if (n < i.length) {
            var u = i[n];
            u.parentNode.insertBefore(e, u), i.splice(n, 0, a)
        } else d(e, t), i.push(a);
        a[o] = t, r in a || (a[r] = [])
    }
    ...
    t.toLogicalRootCommentElement = function(e, t) {
        ...
        return Array.from(n.childNodes).forEach((function(e) {
            return u.push(e)
        })), e[o] = r, t && (e[a] = t, i(t, !0)), i(e, !0)
    }, t.toLogicalElement = i, t.createAndInsertLogicalContainer = function(e, t) {
        var n = document.createComment("!");
        return u(n, e, t), n
    }, t.insertLogicalChild = u, t.removeLogicalChild = function e(t, n) {
        var r = c(t).splice(n, 1)[0];
        if (r instanceof Comment)
            for (var o = c(r); o.length > 0;) e(r, 0);
        var a = r;
        a.parentNode.removeChild(a)
    }, t.getLogicalParent = s, t.getLogicalSiblingEnd = function(e) {
        return e[a] || null
    }, t.getLogicalChild = function(e, t) {
        return c(e)[t]
    }, t.isSvgElement = function(e) {
        return "http://www.w3.org/2000/svg" === l(e).namespaceURI
    }, t.getLogicalChildrenArray = c, t.permuteLogicalChildren = function(e, t) {
        var n = c(e);
    ...
    ! function(e) {
        ...
        function s(e, t, r, a) {
            if (e && r) throw new Error("For instance method calls, assemblyName should be null. Received '" + e + "'.");
            var i = o++,
        ...
        function l(e, t, r) {
            if (!n.hasOwnProperty(e)) throw new Error("There is no pending async call with ID " + e + ".");
            var o = n[e];
            delete n[e], t ? o.resolve(r) : o.reject(r)
        }
        ...
        function p(e) {
            ...
            if (e.split(".").forEach((function(e) {
                    if (!(e in n)) throw new Error("Could not find '" + e + "' in '" + o + "'.");
                    t = n, n = n[e], o += "." + e
        ...
        e.attachDispatcher = function(e) {
            a = e
        }, e.attachReviver = i, e.invokeMethod = function(e, t) {
    ...
    var r = n(27),
        ...
        p = function() {
            ...
            return e.prototype.attachRootComponentToLogicalElement = function(e, t) {
                ...
                if (!o) throw new Error("No element is currently associated with component " + t);
                var i = d[t];
                if (i) {
                    var u = a.getLogicalSiblingEnd(i);
                    delete d[t], u ? function(e, t) {
                        var n = a.getLogicalParent(e);
                        if (!n) throw new Error("Can't clear between nodes. The start node does not have a logical parent.");
                        for (var r = a.getLogicalChildrenArray(n), o = r.indexOf(e) + 1, i = r.indexOf(t), u = o; u <= i; u++) a.removeLogicalChild(n, o);
                        e.textContent = "!"
                    }(i, u) : function(e) {
                        var t;
                ...
                var s = a.getClosestDomElement(o).ownerDocument,
                    c = s && s.activeElement;
                this.applyEdits(e, t, o, 0, n, r), c instanceof HTMLElement && s && s.activeElement !== c && c.focus()
                ...
                for (var s, c = 0, l = o, f = e.arrayBuilderSegmentReader, d = e.editReader, p = e.frameReader, h = f.values(i), m = f.offset(i), v = m + f.count(i), y = m; y < v; y++) {
                    ...
                    switch (g) {
                        ...
                        case r.EditType.setAttribute:
                            w = d.newTreeIndex(b), E = e.referenceFramesEntry(u, w), _ = d.siblingIndex(b);
                            if (!((C = a.getLogicalChild(n, l + _)) instanceof Element)) throw new Error("Cannot set attribute on non-element child");
                            this.applyAttribute(e, t, C, E);
                            break;
                        case r.EditType.removeAttribute:
                            var C;
                            _ = d.siblingIndex(b);
                            if (!((C = a.getLogicalChild(n, l + _)) instanceof HTMLElement)) throw new Error("Cannot remove attribute from non-element child");
                        ...
                        case r.EditType.updateText:
                            ...
                            if (!(S instanceof Text)) throw new Error("Cannot set text content on non-text child");
                            S.textContent = p.textContent(E);
                            break;
                        case r.EditType.updateMarkup:
                            w = d.newTreeIndex(b), E = e.referenceFramesEntry(u, w), _ = d.siblingIndex(b);
                            a.removeLogicalChild(n, l + _), this.insertMarkup(e, n, l + _, E);
                            break;
                        case r.EditType.stepIn:
                            _ = d.siblingIndex(b);
                            n = a.getLogicalChild(n, l + _), c++, l = 0;
                            break;
                        case r.EditType.stepOut:
                            n = a.getLogicalParent(n), l = 0 === --c ? o : 0;
                            break;
                        ...
                        case r.EditType.permutationListEnd:
                            a.permuteLogicalChildren(n, s), s = void 0;
                            break;
                        default:
                ...
                switch (l) {
                    case r.FrameType.element:
                        return this.insertElement(e, t, n, o, a, u, s), 1;
                    case r.FrameType.text:
                        return this.insertText(e, n, o, u), 1;
                    case r.FrameType.attribute:
                        throw new Error("Attribute frames should only be present as leading children of element frames.");
                    case r.FrameType.component:
                        return this.insertComponent(e, n, o, u), 1;
                    ...
                    case r.FrameType.elementReferenceCapture:
                        if (n instanceof Element) return i.applyCaptureIdToElement(n, c.elementReferenceCaptureId(u)), 0;
                        throw new Error("Reference capture frames can only be children of element frames.");
                    case r.FrameType.markup:
                        return this.insertMarkup(e, n, o, u), 1;
                    default:
                ...
                if (f instanceof HTMLSelectElement && "_blazorSelectValue" in f) {
                    ...
                    f.value = v, delete f._blazorSelectValue
                }
                ...
                for (var o, i = a.createAndInsertLogicalContainer(t, n), u = e.frameReader.markupContent(r), s = (o = u, a.isSvgElement(t) ? (l.innerHTML = o || " ", l) : (c.innerHTML = o || " ", c.content)), f = 0; s.firstChild;) a.insertLogicalChild(s.firstChild, i, f++)
                ...
                } else this.tryApplySpecialProperty(e, n, a, r) || n.setAttribute(a, o.attributeValue(r))
                ...
                switch (t.tagName) {
                    ...
                    case "TEXTAREA":
                        ...
                        return t.value = a, "SELECT" === t.tagName && (t._blazorSelectValue = a), !0;
                    case "OPTION":
                        (a = n ? r.attributeValue(n) : null) ? t.setAttribute("value", a): t.removeAttribute("value");
                        var i = this.findClosestAncestorSelectElement(t);
                        return i && "_blazorSelectValue" in i && i._blazorSelectValue === a && (this.tryApplyValueProperty(e, i, n), delete i._blazorSelectValue), !0;
                    default:
                        return !1
                }
                ...
                for (var u = r, s = a; s < i; s++) {
                    ...
                    r += this.insertFrame(e, t, n, r, o, c, s), s += h(e, c)
                }
                return r - u
            }, e
        }();
    ...
    var r = n(29),
        ...
        u = function() {
            function e(t) {
                ...
                this.eventsCollectionKey = "_blazorEvents_" + n, this.eventInfoStore = new s(this.onGlobalEvent.bind(this))
            }
            return e.prototype.setListener = function(e, t, n, r) {
                var o = this.getEventHandlerInfosForElement(e, !0),
                    a = o.getHandler(t);
                if (a) this.eventInfoStore.update(a.eventHandlerId, n);
                else {
                    var i = {
                        element: e,
                        eventName: t,
                ...
                if (e.target instanceof Element) {
                    for (var t, n, u = e.target, s = null, c = a.hasOwnProperty(e.type), l = !1; u;) {
                        ...
                        if (f) {
                            ...
                            if (d && (t = u, n = e.type, !((t instanceof HTMLButtonElement || t instanceof HTMLInputElement || t instanceof HTMLTextAreaElement || t instanceof HTMLSelectElement) && i.hasOwnProperty(n) && t.disabled))) {
    ...
    var s = function() {
            ...
            return e.prototype.add = function(e) {
                ...
                if (this.countByEventName.hasOwnProperty(e)) this.countByEventName[e]++;
                else {
    ...
    t.showErrorNotification = function() {
        return r(this, void 0, void 0, (function() {
            var e;
            return o(this, (function(t) {
                return (e = document.querySelector("#blazor-error-ui")) && (e.style.display = "block"), a || (a = !0, document.querySelectorAll("#blazor-error-ui .reload").forEach((function(e) {
    ...
    }, t.readUint32LE = a, t.readUint64LE = function(e, t) {
        var n = a(e, t + 4);
    ...
    t.decodeUtf8 = r ? r.decode.bind(r) : function(e) {
        ...
        for (; t < n;) {
            ...
            if (0 == (128 & a)) r.push(a);
                ...
                var s = 63 & e[t++],
                    c = (7 & a) << 18 | i << 12 | u << 6 | s;
                c > 65535 && (c -= 65536, r.push(c >>> 10 & 1023 | 55296), c = 56320 | 1023 & c), r.push(c)
            }
    ...
    function v(e) {
        return r(this, void 0, void 0, (function() {
            var t, n, l, v, y, b = this;
            return o(this, (function(g) {
                switch (g.label) {
                    case 0:
                        if (m) throw new Error("Blazor has already started.");
                        return m = !0, f.setEventDispatcher((function(e, t) {
                            return DotNet.invokeMethodAsync("Microsoft.AspNetCore.Components.WebAssembly", "DispatchEvent", e, JSON.stringify(t))
                        })), t = i.setPlatform(u.monoPlatform), window.Blazor.platform = t, window.Blazor._internal.renderBatch = function(e, t) {
                    ...
                    case 1:
                        return n = g.sent(), [4, Promise.all([d.WebAssemblyResourceLoader.initAsync(n.bootConfig, e || {}), p.WebAssemblyConfigLoader.initAsync(n)])];
                    case 2:
                        l = a.apply(void 0, [g.sent(), 1]), v = l[0], g.label = 3;
                    case 3:
                        return g.trys.push([3, 5, , 6]), [4, t.start(v)];
                    case 4:
                        return g.sent(), [3, 6];
                    case 5:
                        throw y = g.sent(), new Error("Failed to start platform. Reason: " + y);
                    case 6:
                        return t.callEntryPoint(v.bootConfig.entryAssembly), [2]
                }
            }))
        }))
    }
    window.Blazor.start = v, l.shouldAutoStart() && v().catch((function(e) {
    ...
    t.monoPlatform = {
        start: function(e) {
            return new Promise((function(t, n) {
                var c, l;
                i.attachDebuggerHotkey(e), window.Browser = {
                    init: function() {}
                }, c = function() {
                    window.Module = function(e, t, n) {
                            ...
                            }, f.preRun = f.preRun || [], f.postRun = f.postRun || [], f.preloadPlugins = [];
                            var v, y = e.loadResources(l.assembly, (function(e) {
                                    return "_framework/_bin/" + e
                                }), "assembly"),
                                b = e.loadResources(l.pdb || {}, (function(e) {
                                    return "_framework/_bin/" + e
                                }), "pdb"),
                                g = e.loadResource("dotnet.wasm", "_framework/wasm/dotnet.wasm", e.bootConfig.resources.runtime["dotnet.wasm"], "dotnetwasm");
                            return e.bootConfig.resources.runtime.hasOwnProperty("dotnet.timezones.dat") && (v = e.loadResource("dotnet.timezones.dat", "_framework/wasm/dotnet.timezones.dat", e.bootConfig.resources.runtime["dotnet.timezones.dat"], "timezonedata")), f.instantiateWasm = function(e, t) {
                                return r(c, void 0, void 0, (function() {
                                    var n, r;
                                    return o(this, (function(o) {
                                        switch (o.label) {
                                            case 0:
                                                return o.trys.push([0, 3, , 4]), [4, g];
                                            case 1:
                                                return [4, m(o.sent(), e)];
                                            case 2:
                                                return n = o.sent(), [3, 4];
                                            case 3:
                                                throw r = o.sent(), f.printErr(r), r;
                                            case 4:
                                                return t(n), [2]
                                        }
                                    }))
                                ...
                                a = cwrap("mono_wasm_add_assembly", null, ["string", "number", "number"]), cwrap("mono_wasm_string_get_utf8", "number", ["number"]), MONO.loaded_files = [], v && function(e) {
                                    r(this, void 0, void 0, (function() {
                                        ...
                                        return o(this, (function(r) {
                                            switch (r.label) {
                                                ...
                                                case 2:
                                                    return n = r.sent(), s.loadTimezoneData(n), removeRunDependency(t), [2]
                                            }
                                        }))
                                    }))
                                    ...
                                    if (a) {
                                        ...
                                        return BINDING.js_to_mono_obj(i.then((function(e) {
                                            return e.length && (window.Blazor._internal.readSatelliteAssemblies = function() {
                                                for (var t = BINDING.mono_obj_array_new(e.length), n = 0; n < e.length; n++) BINDING.mono_obj_array_set(t, n, BINDING.js_typed_array_to_array(new Uint8Array(e[n])));
                                                return t
                                            }), e.length
                                        })))
                                    }
                                ...
                                var n, r, o;
                                e.bootConfig.debugBuild && e.bootConfig.cacheBootResources && e.logToConsole(), e.purgeUnusedCacheEntriesAsync(), MONO.mono_wasm_setenv("MONO_URI_DOTNETRELATIVEORABSOLUTE", "true"), cwrap("mono_wasm_load_runtime", null, ["string", "number"])("appBinDir", i.hasDebuggingEnabled() ? -1 : 0), MONO.mono_wasm_runtime_ready(), n = h("Microsoft.AspNetCore.Components.WebAssembly", "Microsoft.AspNetCore.Components.WebAssembly.Services.DefaultWebAssemblyJSRuntime", "InvokeDotNet"), r = h("Microsoft.AspNetCore.Components.WebAssembly", "Microsoft.AspNetCore.Components.WebAssembly.Services.DefaultWebAssemblyJSRuntime", "BeginInvokeDotNet"), o = h("Microsoft.AspNetCore.Components.WebAssembly", "Microsoft.AspNetCore.Components.WebAssembly.Services.DefaultWebAssemblyJSRuntime", "EndInvokeJS"), DotNet.attachDispatcher({
                                    beginInvokeDotNetFromJS: function(e, t, n, o, a) {
                                        if (!o && !t) throw new Error("Either assemblyName or dotNetObjectId must have a non null value.");
                                ...
                                return r(this, void 0, void 0, (function() {
                                    ...
                                    return o(this, (function(o) {
                                        switch (o.label) {
                                            ...
                                            case 2:
                                                return i = o.sent(), u = new Uint8Array(i), s = Module._malloc(u.length), new Uint8Array(Module.HEAPU8.buffer, s, u.length).set(u), a(t, s, u.length), MONO.loaded_files.push((l = e.url, d.href = l, d.href)), [3, 4];
                                            case 3:
                        ...
                        function(e) {
                            ...
                            if (r.src = "_framework/wasm/" + t, r.defer = !0, e.bootConfig.cacheBootResources && (r.integrity = n, r.crossOrigin = "anonymous"), e.startOptions.loadBootResource) {
                                var o = e.startOptions.loadBootResource("dotnetjs", t, r.src, n);
                                if ("string" == typeof o) r.src = o;
                                else if (o) throw new Error("For a dotnetjs resource, custom loaders must supply a URI string.")
                            }
                            document.body.appendChild(r)
                        }(e)
                }, l = document.createElement("script"), window.__wasmmodulecallback__ = c, l.type = "text/javascript", l.text = "var Module; window.__wasmmodulecallback__(); delete window.__wasmmodulecallback__;", document.body.appendChild(l)
            }))
        },
        ...
        readUint64Field: function(e, t) {
            return function(e) {
                ...
                if (n > l) throw new Error("Cannot read uint64 with high order part " + n + ", because the result would exceed Number.MAX_SAFE_INTEGER.");
    ...
    t.hasDebuggingEnabled = a, t.attachDebuggerHotkey = function(e) {
        o = !!e.bootConfig.resources.pdb;
        var t = navigator.platform.match(/^Mac/i) ? "Cmd" : "Alt";
        a() && console.info("Debugging hotkey: Shift+" + t + "+D (when application has focus)"), document.addEventListener("keydown", (function(e) {
            var t;
            e.shiftKey && (e.metaKey || e.altKey) && "KeyD" === e.code && (o ? r ? ((t = document.createElement("a")).href = "_framework/debug?url=" + encodeURIComponent(locationProxy.href), t.target = "_blank", t.rel = "noopener noreferrer", t.click()) : console.error("Currently, only Microsoft Edge (80+), or Google Chrome, are supported for debugging.") : console.error("Cannot start debugging, because the application was not compiled with debugging enabled."))
        }))
    }
}, function(e, t, n) {
    "use strict";
    ...
    t.loadTimezoneData = function(e) {
        var t, n, u = new Uint8Array(e),
            s = a.readInt32LE(u, 0);
        u = u.slice(4);
        var c = i.decodeUtf8(u.slice(0, s)),
            l = JSON.parse(c);
        u = u.slice(s), Module.FS_createPath("/", "zoneinfo", !0, !0), new Set(l.map((function(e) {
            return e[0].split("/")[0]
        }))).forEach((function(e) {
        ...
        try {
            for (var f = r(l), d = f.next(); !d.done; d = f.next()) {
                var p = o(d.value, 2),
                    ...
                    m = p[1],
                    v = u.slice(0, m);
                Module.FS_createDataFile("/zoneinfo/" + h, null, v, !0, !0, !0), u = u.slice(m)
            }
        } catch (e) {
            t = {
                error: e
    ...
    var r = n(18),
        o = function() {
            function e(e) {
                this.batchAddress = e, this.arrayRangeReader = a, this.arrayBuilderSegmentReader = i, this.diffReader = u, this.editReader = s, this.frameReader = c
            }
        ...
        i = function() {
            ...
            return e.initAsync = function(t, n) {
                ...
                if (0 !== o) {
                    ...
                    console.groupCollapsed("%cblazor%c Loaded " + c(o) + " resources" + a, "background: purple; color: white; padding: 1px 3px; border-radius: 3px;", "font-weight: bold;", "font-weight: normal;"), e.length && (console.groupCollapsed("Loaded " + c(n) + " resources from cache"), console.table(this.cacheLoads), console.groupEnd()), t.length && (console.groupCollapsed("Loaded " + c(r) + " resources from network"), console.table(this.networkLoads), console.groupEnd()), console.groupEnd()
                }
                ...
                return r(this, void 0, void 0, (function() {
                    ...
                    return o(this, (function(i) {
                        switch (i.label) {
                            ...
                            case 1:
                                return t = i.sent(), n = t.map((function(t) {
                ...
                return r(this, void 0, void 0, (function() {
                    ...
                    return o(this, (function(o) {
                        switch (o.label) {
                            case 0:
                                if (!i || 0 === i.length) throw new Error("Content hash is required");
                                return r = a.toAbsoluteUri(n + "." + i), this.usedCacheKeys[r] = !0, [4, e.match(r)];
                            case 1:
                                return (s = o.sent()) ? (c = parseInt(s.headers.get("content-length") || "0"), this.cacheLoads[t] = {
                                    responseBytes: c
                                }, [2, s]) : [3, 2];
                            case 2:
                                return [4, this.loadResourceWithoutCaching(t, n, i, u)];
                            case 3:
                                return l = o.sent(), this.addToCacheAsync(e, t, r, l), [2, l]
                        }
                    }))
                }))
                ...
                return r(this, void 0, void 0, (function() {
                    ...
                    return o(this, (function(o) {
                        switch (o.label) {
                            ...
                            case 1:
                                return r = o.sent(), i = function(e) {
                                    if ("undefined" != typeof performance) return performance.getEntriesByName(e)[0]
                                }(a.url), u = i && i.encodedBodySize || void 0, this.networkLoads[t] = {
                                    responseBytes: u
                                }, [4, e.put(n, new Response(r, {
                                    headers: {
    ...
    function u(e) {
        return r(this, void 0, void 0, (function() {
            ...
            return o(this, (function(r) {
                switch (r.label) {
                    case 0:
                        if (!e.cacheBootResources || "undefined" == typeof caches) return [2, null];
                        t = document.baseURI.substring(document.location.origin.length), n = "blazor-resources-" + t, r.label = 1;
                    case 1:
            ...
            return r(this, void 0, void 0, (function() {
                ...
                return o(this, (function(i) {
                    switch (i.label) {
                        ...
                        case 1:
                            return n = i.sent(), window.Blazor._internal.getConfig = function(e) {
            ...
            return r(this, void 0, void 0, (function() {
                ...
                return o(this, (function(r) {
                    switch (r.label) {
                        ...
                        case 1:
                            return t = r.sent(), n = t.headers.get("Blazor-Environment") || "Production", [4, t.json()];
                        case 2:
